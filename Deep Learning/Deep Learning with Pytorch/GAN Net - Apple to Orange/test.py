...
if __name__ == '__main__':
    ...
    netG_A2B.load_state_dict(torch.load("./models/netG_A2B.pth", map_location=torch.device('cpu')))
    netG_B2A.load_state_dict(torch.load("./models/netG_B2A.pth", map_location=torch.device('cpu')))
    ...
    dataloader = DataLoader(ImageDataset(data_root, transforms_, model="test"),
